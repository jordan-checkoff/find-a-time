...
// export enum EventViewPages {
//     VIEW,
//     EDIT
// }

// export interface EventViewInterface {
//     loading: boolean
//     // event: Event | null,
//     page: EventViewPages
//     // user: string | null,
...
//     return (
//         <EventView model={state} handleEvent={dispatch} model2={calendarState} handleEvent2={calendarDispatch} />
//     )
// }